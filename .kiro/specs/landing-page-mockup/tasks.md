...
- [ ] 4. ヒーローセクションの実装
- [ ] 4.1 (P) Heroコンポーネントの基本構造とテキストコンテンツ実装
...
- [ ] 4.2 (P) HeroセクションのCTAボタンとビジュアル実装
...
- [ ] 5. 機能紹介セクションの実装
- [ ] 5.1 (P) Featuresコンポーネントの基本構造とモックデータ実装
...
- [ ] 5.2 (P) 機能カードのレイアウトとshadcn/ui統合実装
