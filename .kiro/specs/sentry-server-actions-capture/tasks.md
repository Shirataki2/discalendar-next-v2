...
- [ ] 1. 認証 Server Action のエラーキャプチャ追加
- [ ] 1.1 (P) signOut のエラーを Sentry にキャプチャする
...
- [ ] 2. ダッシュボード Server Actions のエラーキャプチャ追加
- [ ] 2.1 (P) ギルド設定・通知チャンネル操作のエラーキャプチャ
