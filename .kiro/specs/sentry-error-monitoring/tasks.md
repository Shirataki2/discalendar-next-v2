...
- [x] 2. Sentry SDK初期化設定ファイルを作成する
- [x] 2.1 (P) クライアントサイドのSentry初期化設定を作成する
...
- [x] 3.2 Next.js設定にSentryビルド統合を追加する
